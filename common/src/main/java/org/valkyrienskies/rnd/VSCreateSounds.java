...
import org.valkyrienskies.rnd.platform.api.DeferredRegister;
...
public class VSCreateSounds {
    ...
    SUPERSONIC = create("supersonic").subtitle("Supersonic")
            ...
            ;
    private static final DeferredRegister<SoundEvent> sounds = DeferredRegister.create(Registry.SOUND_EVENT, VSCreateMod.MOD_ID);
